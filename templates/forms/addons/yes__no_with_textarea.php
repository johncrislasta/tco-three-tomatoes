...
<div class="addon">
    ...
    <div class="answers-container">
        <label class="answer">
            <input type="radio" name="<?php echo $question_slug ?>" value="Yes"
                   data-price="<?php echo $price_for_yes ?? 0 ?>"/>
        ...
        <label class="answer">
            <input type="radio" name="<?php echo sanitize_title($question) ?>" value="No"
                   data-price="<?php echo $price_for_no ?? 0 ?>"/>
    ...
    <div class="secondary-question" data-show_if="Yes" style="display:none">
        ...
        <textarea name="plate-meal-addon-<?php echo $secondary_question_slug ?>" placeholder="<?php echo $textarea_placeholder ?>"></textarea>
