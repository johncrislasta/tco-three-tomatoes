...
<div id="venue-contact-name-input" class="plated-meals-input-wrapper">
    ...
    <input id="venue-contact-name-input" name="venue_contact_number" type="tel"
           placeholder="(###) ###-####"
           pattern="([0-9]{3}) [0-9]{3}-[0-9]{4}" required
           data-custom_validation="validate_phone_format"
           data-custom_validation_message="Follow this format (###) ###-####"
    >
</div>